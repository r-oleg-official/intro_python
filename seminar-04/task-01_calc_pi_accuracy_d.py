...
def real_pi(value: str) -> str:
    pi_100_symbol = str(
        1415926535897932384626433832795028841971693993751058209749445623078164062862089986280348253421170679)
...
def main():
    ...
    for item in methods_li:
        print('{}: {}'.format(item, methods_li[item]))
